...
@app.route("/")
def main():
    biblebooks = {"Genesis":50, "Exodus":40, "Leviticus":27, "Numbers":36, "Deuteronomy":34, "Joshua":24,
               ...
               "Psalms":150, "Proverbs":31, "Ecclesiastes":12, "The Song of Solomon":8, "Isaiah":66,
    ...
    book, number = random.choice(list(biblebooks.items()))
    chapter = random.randrange(1,number)
    verse = random.randint(1,176)
    return render_template('index.html',verse = [book,chapter,verse])
